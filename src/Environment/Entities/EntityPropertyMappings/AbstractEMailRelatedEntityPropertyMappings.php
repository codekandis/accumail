...
/**
 * Represents the base class of any e-mail related entity property mappings.
 * @package codekandis/accumail
 * @author Christian Ramelow <info@codekandis.net>
 */
class AbstractEMailRelatedEntityPropertyMappings extends AbstractEntityPropertyMappings
{
	/**
	 * Constructor method.
	...
	{
		parent::__construct(
			new EntityPropertyMapping( 'eMailId', null ),
